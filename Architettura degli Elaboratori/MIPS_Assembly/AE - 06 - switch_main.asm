...
# quindi inserire un valore diverso da 0 o 1 nella terza selezone porta il PC a puntare
...
.data
	...
	forbidden_string: .asciiz "Forbidden"
	forbidden_area: .word forbidden
