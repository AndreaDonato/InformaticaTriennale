...
### Salva stato dei registri ###
  ...
  sw $ra,  0($sp)     # First: save the return address (così se chiamo una funzione annidata non mi perdo dove devo tornare) 
  sw $fp,  4($sp)     # Save the frame (function) pointer. Though not used, really.
